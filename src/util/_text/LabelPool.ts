...
uniform bool uBillboard;//是否始终看向相机
uniform bool uSizeAttenuation;//是否大小衰减
...
export class Label extends THREE.Object3D {
  ...
  constructor(public labelPool: LabelPool) {
    ...
    console.log('this.instanceCharSize ',this.instanceCharPosition );
